...
**Primary Dependencies**: Laravel API stack, Angular SPA, Bootstrap, ngx-formly, ngx-datatable, Laravel queue workers, JWT authentication, Qdrant vector search, Ollama chat and embedding models  
**Storage**: MySQL for relational data, Qdrant for tenant-scoped vector embeddings, object/file storage for uploaded documents  
