...
Route::prefix('v1')->group(function (): void {
    ...
    Route::middleware('auth.token')->group(function (): void {
        ...
        Route::get('/documents/{documentId}/preparation-runs/{runId}', [DocumentController::class, 'showPreparationRun'])->middleware('role:super-admin,tenant-admin,operator,viewer');

        Route::get('/rag/chunking-profiles', [DocumentController::class, 'listChunkingProfiles'])->middleware('role:super-admin,tenant-admin,operator');

        Route::post('/search/queries', [SearchController::class, 'query'])->middleware('role:super-admin,tenant-admin,operator,viewer');
        Route::get('/chat/conversations', [ChatController::class, 'index'])->middleware('role:super-admin,tenant-admin,operator,viewer');
        Route::post('/chat/conversations', [ChatController::class, 'store'])->middleware('role:super-admin,tenant-admin,operator,viewer');
        Route::get('/chat/conversations/{conversationId}', [ChatController::class, 'show'])->middleware('role:super-admin,tenant-admin,operator,viewer');
        Route::post('/chat/conversations/{conversationId}/archive', [ChatController::class, 'archive'])->middleware('role:super-admin,tenant-admin,operator,viewer');
        Route::delete('/chat/conversations/{conversationId}', [ChatController::class, 'destroy'])->middleware('role:super-admin,tenant-admin,operator,viewer');
        Route::post('/chat/conversations/{conversationId}/messages', [ChatController::class, 'message'])->middleware('role:super-admin,tenant-admin,operator,viewer');
        ...
        Route::patch('/tenants/{tenantId}', [TenantController::class, 'update'])->middleware('role:super-admin');
        ...
        Route::patch('/users/{userId}', [UserController::class, 'update'])->middleware('role:super-admin,tenant-admin');
