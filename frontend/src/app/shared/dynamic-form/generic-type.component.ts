...
@Component({
  ...
  <ng-container *ngFor="let f of field.fieldGroup">
    <ng-container [ngSwitch]="f.type">
      ...
      <formly-field *ngSwitchCase="'selectIn'" [field]="f"></formly-field>
      <formly-field *ngSwitchCase="'selectrelation'" [field]="f"></formly-field>
      <formly-field *ngSwitchCase="'buttonselection'" [field]="f"></formly-field>
      ...
      <formly-field *ngSwitchCase="'dateyear'" [field]="f"></formly-field>               
    </ng-container>
  </ng-container>
  `,
    styles: [],
